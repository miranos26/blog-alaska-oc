...
Class MysqlDatabase extends Database{
    ...
    public function __construct($db_name = 'keviykqh_blog', $db_user ='keviykqh_kcadier', $db_pass = 'ER4UF52607', $db_host = 'localhost') {
    ...
    private function getPDO(){
        ...
        if($this->pdo === null){
            $pdo = new PDO('mysql:dbname=keviykqh_blog;host=localhost', 'keviykqh_kcadier', 'ER4UF52607', array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES \'UTF8\''));

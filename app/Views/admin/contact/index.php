                        ...
                        <?php foreach (array_reverse($messages) as $message): ?>
                            ...
                            <?php $dateConverter = new viewFunction(); ?>
                                <tr>
                                    ...
                                    <td> <?= $message->email; ?> </td>
                                    <td> <?= $dateConverter->dateConvertWithTime($message->date)?> </td>
                                    <td> <a class="btn btn-secondary" href="?p=admin.contact.show&id=<?= $message->id; ?> "> <i class="fas fa-angle-double-right"></i> Voir </a> </td>
                                    ...
                                    <td>
                                        <form action="?p=admin.contact.delete&id=<?= $message->id; ?>" method="post" style="display:inline;">
